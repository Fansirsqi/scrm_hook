...
(function () {
  ...
  function showPopup(message, duration) {
    setTimeout(function () {
      ...
      popup.style.cssText =
        "position:fixed; top:50%; left:50%; transform:translate(-50%, -50%); background-color:#fff; padding:15px; border:none;border-radius: 12px; font-size:32px;font-weight: 700;color:#f50000; box-shadow: 0px 1px 20px 0px #6b6b6b;";
